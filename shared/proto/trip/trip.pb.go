...
type PreviewTripResponse struct {
	...
	RideFares     []*RideFare            `protobuf:"bytes,3,rep,name=rideFares,proto3" json:"rideFares,omitempty"` // repeated means array
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type Route struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Geometry      []*Geometry            `protobuf:"bytes,1,rep,name=geometry,proto3" json:"geometry,omitempty"` // repeated means array
